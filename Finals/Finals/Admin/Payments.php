        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush my-3">
                    ...
                    <a href="../admin/Student.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold ">
                        <i class="fas fa-user-graduate me-2"></i> Student
                    </a>
                    <a href="../Admin/Payments.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold active">
            ...
            <div id="page-content-wrapper">
                        ...
                        <div class="col-md-3">
                            <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                                <div>
                                    ...
                                    <a href="Receipt.php"><button type="button" class="btn btn-outline-primary">View</button></a>
                                </div>
                ...
                <div class="container-fluid my-5">
                    <div class="input-group rounded row">
                        ...
                        <input type="search" v-model="search" @input="searchPay(search)" class="form-control ms-5 mb-2 rounded-3 col-sm-6" placeholder="Search Student">
                        </span>
                    </div>

                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead class="text-center w-auto">
                                <tr>
                            ...
                            <tbody id="tbl" class="text-center">
                                <tr v-for="paystud in allPayment">
                                    <td>{{ paystud.student_id }}</td>
                                    <td>{{ paystud.last_name }}</td>
                                    <td>{{ paystud.first_name }}</td>
                                    <td>{{ paystud.course }}</td>
                                    <td>{{ paystud.paymentType == 1 ? "Tuition Pay" : paystud.paymentType == 2 ? "Miscellaneous" : "Project" }}</td>
                                    <td>{{ paystud.amount }}</td>
                                    <td>{{ paystud.status == 0 ? 'Pending' : paystud.status == 1 ? "Approve" : "Decline" }}</td>
                                    <td>
                                        <button type="button" @click="approveStatus(paystud.payment_id)" class="btn btn-success btn-sm me-2">ACCEPT</button>
                                        <button type="button" @click="RequestDecline(paystud.payment_id)" class="btn btn-danger btn-sm">DECLINE</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
